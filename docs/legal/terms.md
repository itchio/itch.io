...
itch.io provides interfaces and tools for Users to generate content and make it
...
If a counter-notice is received, Company may send a copy to the original
